...
import com.omgrod.gdvr.GeometryDashActivity
import com.omgrod.gdvr.R
import com.omgrod.gdvr.preferences.SettingsActivity
...
fun onLaunch(context: Context, safeMode: Boolean = false, vrMode: Boolean = true) {
    if (safeMode) {
    ...
    launchIntent.putExtra("isVRMode", vrMode)
