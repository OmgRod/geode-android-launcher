...
import com.omgrod.gdvr.preferences.ApplicationLogsActivity
import com.omgrod.gdvr.BuildConfig
import com.omgrod.gdvr.R
import com.omgrod.gdvr.UserDirectoryProvider
import com.omgrod.gdvr.preferences.GeodeLogsListingActivity
import com.omgrod.gdvr.preferences.TextViewActivity
...
fun DownloadRecommendation(needsUniversal: Boolean, modifier: Modifier = Modifier) {
    ...
    val downloadBase = "https://github.com/GeometryDashVR/android-launcher/releases/download/$version"
