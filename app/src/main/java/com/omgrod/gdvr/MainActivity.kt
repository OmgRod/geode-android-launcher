...
import com.omgrod.gdvr.ui.theme.Theme.DARK
import com.omgrod.gdvr.ui.theme.Theme.LIGHT
import com.omgrod.gdvr.ui.theme.launcherTitleStyle
import com.omgrod.gdvr.ui.theme.sapphireTitleStyle
import com.omgrod.gdvr.updater.ReleaseManager
    ...
    Box(
        ...
        if (basePalette.animatedIcon != null) {
            Crossfade(
                ...
                when (screen) {
                    true -> AnimatedLogo(modifier = Modifier.size(128.dp, 128.dp), spec = basePalette.animatedIcon)
                    false -> Image(
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                val basePalette = geodeColorPalette
