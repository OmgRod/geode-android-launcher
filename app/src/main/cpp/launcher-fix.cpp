...
extern "C"
JNIEXPORT void JNICALL Java_com_omgrod_gdvr_LauncherFix_setDataPath(
        JNIEnv *env,
        jobject,
        jstring data_path
) {
...
extern "C"
JNIEXPORT void JNICALL Java_com_omgrod_gdvr_LauncherFix_setOriginalDataPath(
        JNIEnv *env,
        jobject,
        jstring data_path
) {
...
extern "C"
JNIEXPORT void JNICALL Java_com_omgrod_gdvr_LauncherFix_enableExceptionsRenaming(JNIEnv*, jobject) {
    DataPaths::patch_exceptions = true;
}

// this should be called after gd is loaded but before geode
extern "C" JNIEXPORT void JNICALL Java_com_omgrod_gdvr_LauncherFix_performPatches(JNIEnv*, jobject) {
